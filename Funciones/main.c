...
void menu()
{
    ...
    do
    {
        ...
        case 1:
            ...
            break;
        case 2:
            bajaEmpleado(lista, TAM, flag);
            break;
        case 3:
            modificar(lista, TAM, flag);
            break;
        case 4:
            listadoEmpleados(lista,TAM,sectores,TS,flag);
            listadoDeSalarios(lista,TAM,sectores,TS,flag);
            break;
        case 5:
...
void ordenarNombres(eEmpleado lista[], int cantidad)
{
    int i,j;
    eEmpleado aux;
...
void ordenarNombresConStrcmp(eEmpleado lista[], int cantidad)
{
    int i,j;
    eEmpleado aux;
    for(i=0; i<cantidad-1; i++)
    {
        ...
        for(j=i+1; j<cantidad; j++)
        {
            ...
            {
                strcmp(aux.nombre,lista[i].nombre);
                strcmp(lista[i].nombre,lista[j].nombre);
                strcmp(lista[j].nombre,aux.nombre);
            }
        }
    }
}
